...
local RetroAdmin = Instance.new("ScreenGui")
...
RetroAdmin.Name = "RetroAdmin"
RetroAdmin.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
RetroAdmin.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
RetroAdmin.ResetOnSpawn = false

Frame.Parent = RetroAdmin

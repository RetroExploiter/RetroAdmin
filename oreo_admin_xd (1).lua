...
game:GetService("StarterGui"):SetCore("SendNotification", {
			Title = "Oreo Admin";
			Text = "Oreo Admin Has Loaded Made By Niceman";
			})
Commands = {
...
local OreoAdmin = Instance.new("ScreenGui")
...
OreoAdmin.Name = "Oreo Admin"
OreoAdmin.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
OreoAdmin.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
OreoAdmin.ResetOnSpawn = false

Frame.Parent = OreoAdmin
Frame.BackgroundColor3 = Color3.fromRGB(0, 48, 135)
Frame.BorderSizePixel = 0
Frame.Position = UDim2.new(0.00662800297, 0, 0.928221822, 0)
Frame.Size = UDim2.new(0, 166, 0, 37)

ImageLabel.Parent = Frame
ImageLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
ImageLabel.BackgroundTransparency = 1.000
ImageLabel.BorderColor3 = Color3.fromRGB(27, 42, 53)
ImageLabel.Position = UDim2.new(0.00602409616, 0, 0.133333772, 0)
ImageLabel.Size = UDim2.new(0, 163, 0, 26)
ImageLabel.Image = "http://www.roblox.com/asset/?id=3225295081"
ImageLabel.ScaleType = Enum.ScaleType.Fit
ImageLabel.SliceScale = 0.000
ImageLabel.TileSize = UDim2.new(1.60000002, 0, 1.60000002, 0)

CMDBAR.Parent = Frame
CMDBAR.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
CMDBAR.BackgroundTransparency = 1.000
CMDBAR.Position = UDim2.new(0.0481927693, 0, 0, 0)
CMDBAR.Size = UDim2.new(0, 156, 0, 35)
CMDBAR.Font = Enum.Font.SourceSans
CMDBAR.LineHeight = 0.920
CMDBAR.PlaceholderColor3 = Color3.fromRGB(94, 180, 255)
CMDBAR.Text = ""
CMDBAR.TextColor3 = Color3.fromRGB(17, 17, 17)
